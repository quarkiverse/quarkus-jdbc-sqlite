...
package io.quarkiverse.jdbc.sqlite.runtime.substitutions;
 ...
 * @author Colin Decker
 */
@TargetClass(className = "com.google.common.jimfs.PathNormalization")
@Substitute
public enum PathNormalization implements Function<String, String> {
    ...
    CASE_FOLD_UNICODE(Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CASE) {
        @Override
        public String apply(String string) {
            NoClassDefFoundError error = new NoClassDefFoundError("PathNormalization.CASE_FOLD_UNICODE requires ICU4J.");
            throw error;
        }
    },
